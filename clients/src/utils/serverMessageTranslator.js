export const getTranslatedServerMessage = (message, t) => {
  ...
  const map = {
    ...
    "salary paid successfully": t("SalaryPaid"),
    "salary reverted to pending": t("SalaryReverted"),
    "salary already paid": t("SalaryAlreadyPaid"),
    "a reason is required to revert a paid salary": t("RevertReasonRequired"),
    "only paid salaries can be reverted to pending": t("OnlyPaidCanRevert"),
    "role name is required": t("RoleNameRequired"),
    "role name cannot be empty": t("RoleNameRequired"),
  };
