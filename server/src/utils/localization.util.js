...
const messages = {
  en: {
    ...
    TABLE_ORDERS_FETCHED_SUCCESSFULLY: "Table orders fetched successfully",
  },
  ps: {
    // Errors
    ...
    // Order messages
    ORDER_STATUS_UPDATED_SUCCESSFULLY: "د امر حالت بریالی تازه شو",
    ORDER_DELETED_SUCCESSFULLY: "امر بریالی حذف شو",
    ORDER_NOT_FOUND: "امر ونه موندل شو",
    TABLE_ORDERS_FETCHED_SUCCESSFULLY: "د میز امرونه بریالی راوړل شول",
  },
};
