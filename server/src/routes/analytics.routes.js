...
import { getChartData, getSalesComparison, getTopSellingFood, getTopSellingItems, getWorstSellingFood, getDashboardSummary } from "../controllers/analaytics.controller.js";
...
// Top N Best-Selling Items
analyticsRouter.get("/top-selling-items", getTopSellingItems);
